...
namespace UnityAsyncAwaitUtil
{
    public class AsyncUtilTests : MonoBehaviour
    {
        ...
        public void OnGUI()
        {
            ...
            if (_buttonHandler.Display("Test await frame"))
            {
                RunAwaitFrame().WrapErrors();
            }
        ...
        */
        ...
        async Task RunAwaitFrame()
        {
            Debug.LogFormat("frame:{0} Waiting 1 frame...", Time.frameCount);
            await Awaiters.NextFrame;
            Debug.LogFormat("frame:{0} Waiting 1 frame...", Time.frameCount);
            await Awaiters.NextFrame;
            Debug.LogFormat("frame:{0} Done!", Time.frameCount);
        }
    }
}
