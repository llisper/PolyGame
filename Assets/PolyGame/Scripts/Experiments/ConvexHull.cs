...
namespace Experiments
{
    public class ConvexHull : MonoBehaviour
    {
        ...
        void SpecialPoints()
        {
            ...
            Vector2 diag = vertices[2] - vertices[0];
            Vector2 unit = diag.normalized;
            float mag = diag.magnitude;
            vertices.Add(unit * (mag * 0.3f));
            vertices.Add(unit * (mag * 0.6f));
        }
